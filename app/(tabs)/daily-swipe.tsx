...
export default function DailySwipeScreen() {
  ...
  const handleSwipe = (direction: 'left' | 'right' | 'up' | 'down', contact: Contact) => {
    ...
    switch (direction) {
      case 'left':
        ...
        Alert.alert('Contact Snoozed', `${contact.contactName} has been snoozed for 1 day.`);
        break;
      ...
      case 'right':
        ...
        Alert.alert(
          'Message',
          `You're about to message ${contact.contactName}. This would open a message composer in a real app.`
        );
        break;
      ...
      case 'up':
        ...
        Alert.alert('Contacted', `${contact.contactName} has been marked as contacted.`);
        break;
      ...
      case 'down':
        ...
        Alert.alert(
          'Adjust Frequency',
          `How often would you like to be reminded to contact ${contact.contactName}?`,
          [
